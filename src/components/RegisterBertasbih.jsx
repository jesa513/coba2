                        ...
                        <div className="container">
                            <form className="appointment-form" id="appointment-form">
                                ...
                                <div className="form-group-1">
                                    <input ref="username" type="text" name="name" id="name" placeholder="Username" required /> <br />
                                    <input ref="email" type="email" name="email" id="email" placeholder="Email" required /> <br />
                                    <input ref="phone" type="number" name="phone_number" id="phone_number" placeholder="Phone number" required /> <br />
